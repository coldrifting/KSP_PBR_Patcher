...
for %%i in ("%~dp0..\") do set "batch_file_parent_directory=%%~fi"
set "script_location=%batch_file_parent_directory%_SetupScript\setup.py"

python "%script_location%" --mod-folder="%~dp0." --gamedata-folder="%KSP_GameData_Folder%" --texconv-path="%Texconv_Path%"
