...
from data.model.types.core.color_byte import ColorByte
...
from data.model.types.core.int4 import Int4
...
class MeshDataItem:
    ...
    @staticmethod
    def merge(left: 'MeshDataItem | None', right: 'MeshDataItem | None', size: Int2) -> 'MeshDataItem':
        ...
        raise Exception(f"Unknown types: {type(left).__name__}, {type(right).__name__}")
